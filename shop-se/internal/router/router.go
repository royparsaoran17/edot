...
import (
	...
	"shop-se/internal/bootstrap"
	"shop-se/internal/consts"
	"shop-se/internal/handler"
	"shop-se/internal/middleware"
	"shop-se/internal/ucase"
	"shop-se/pkg/logger"
	"shop-se/pkg/msgx"
	"shop-se/pkg/routerkit"

	ucaseContract "shop-se/internal/ucase/contract"
)
...
func (rtr *router) Route() *routerkit.Router {
	...
	// initiate services
	var (
		shopService = shop.NewService(repo)
	)
