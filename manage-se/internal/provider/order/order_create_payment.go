...
func (c *client) CreateOrderPayment(ctx context.Context, orderID string, input presentations.PaymentCreate) (*Order, error) {
	urlEndpoint := c.endpoint("/internal/v1/orders/" + orderID + "/payment")
