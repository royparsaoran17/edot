...
type Product interface {
	...
	GetProductByID(ctx context.Context, productID string) (*entity.ProductDetail, error)
	UpdateProductByID(ctx context.Context, productID string, input presentations.ProductUpdate) error
	CreateProduct(ctx context.Context, input presentations.ProductCreate) (*entity.ProductDetail, error)
}
